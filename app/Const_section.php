 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Const_section[] $const_articles
 * @property-read \App\Menu $menu
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Const_section whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Const_section whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Const_section whereMenuId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Const_section whereSort($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Const_section whereTitle($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Const_section whereUpdatedAt($value)
 * @mixin \Eloquent
 */
