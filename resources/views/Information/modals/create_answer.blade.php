<!-- Modal ANSWER -->
<div id="myModal2" class="modal fade que-answ" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><img src="{{asset( 'img/close-modal.png' ) }}"/></button>
                <h4 class="modal-title">@lang('modals.give_answer')</h4>
            </div>
            <div class="modal-body">
                <form method="" action="">
                    <div class="question-field span-med"></div>
                    <textarea class="faqtextarea" name="faqtextarea"  placeholder="@lang('modals.enter_answer')"></textarea>
